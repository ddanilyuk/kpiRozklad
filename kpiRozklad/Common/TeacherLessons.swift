...
struct DatumTeacher: Codable {
    ...
    let rate: String
    let teachers: [JSONAny]
    let rooms: [RoomTeacher]
    let groups: [GroupTeacher]
...
// MARK: - Group
struct GroupTeacher: Codable {
    let groupID: Int
    let groupFullName, groupPrefix, groupOkr, groupType: String
    let groupURL: String
